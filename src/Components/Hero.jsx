...
import endpoints, { createImageUrl } from '../Services/movieSerices'
      ...
      <div className='w-full h-full'>
        <div className='absolute w-full h-[550px] lg:h-[850px] bg-gradient-to-r from-black' />
          ...
          <div className='absolute w-full top-[10%] lg:top-[25%] p-4 md:p-8'>
            ...
            <p className='w-full md:max-w-[70%] lg:max-w-[50%] sl:max-w-[35%] text-gray-200'>{truncate(overview, 165)}</p>
          </div>
